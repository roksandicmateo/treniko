...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-500 to-primary-700 px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl p-8 dark:bg-gray-900">
        <div className="text-center mb-8">
          ...
          <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">{t('auth.freeReassurance')}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="businessName" className="block text-sm font-medium text-gray-700 mb-2 dark:text-gray-300">
              {t('auth.businessName')}{' '}
              <span className="text-gray-400 font-normal dark:text-gray-500">({t('common.optional')})</span>
            </label>
            <input
              type="text"
              id="businessName"
          ...
          {error && (
            <div className="bg-red-50 text-red-600 px-4 py-3 rounded-lg text-sm dark:bg-red-950/40 dark:text-red-400">
              {error}
            </div>
          )}
