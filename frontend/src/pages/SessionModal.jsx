...
const STATUS_CONFIG = {
  scheduled: { label: {t('sessions.scheduled')}, color: 'bg-blue-100 text-blue-700' },
  completed:  { label: {t('sessions.completed')}, color: 'bg-green-100 text-green-700' },
  cancelled:  { label: {t('sessions.cancelled')}, color: 'bg-gray-100 text-gray-500' },
  no_show:    { label: {t('sessions.noShow')},   color: 'bg-red-100 text-red-600' },
};
