// frontend/src/components/AssignPackageModal.jsx  (NEW FILE)
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
        <h2 className="text-xl font-bold text-gray-900 mb-1">Assign Package</h2>
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            <p className="text-gray-400 text-sm mb-2">No active packages found.</p>
            <p className="text-xs text-gray-400">Create packages in the Packages section first.</p>
          </div>
        ) : (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">
                        ...
                        {p.sessions_per_period && p.period_days
                          ? ` · ${p.sessions_per_period} per ${p.period_days} days`
                          : ''}
                      </p>
                    </div>
                  </button>
            ...
            {selectedPkg?.duration_days && (
              <div className="bg-blue-50 rounded-xl px-4 py-3">
                <p className="text-xs text-blue-700">
                  ...
                  {' '}({selectedPkg.duration_days} days)
                </p>
              </div>
            )}
